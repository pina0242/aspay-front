  ...
  const handleEncryptedData = async (encryptedBody) => {
    ...
    try {
      ...
      if (response.status === 201) {
        ...
        const errorData = responseData[0]?.response ? responseData[0].response : 'Error al actualizar el nivel de transacción.';
        setError(errorData);
        setLoading(false);
      }
    } catch (err) {
  ...
  return (
    <div className="main-container">
      ...
      <div className="regusr-content-container">
        <h1 className="regusr-title">Editar Nivel de Transacción</h1>
        <form className="regusr-form" onSubmit={handleSubmit}>
          <div className="form-group">
            <label htmlFor="idnivtran">ID:</label>
            <input type="text" id="idnivtran" value={idnivtran} disabled />
          </div>
          <div className="form-group">
          ...
          <div className="form-group">
            <label htmlFor="indexc">indExc(1 pos):</label>
