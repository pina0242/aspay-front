      ...
      {showConfirm && (
        <div className="modal-overlay">
          <div className="modal-content">
            ...
            <p>
              ¿Está seguro de que desea eliminar el nivel de transacción para el servicio **{userToEdit.Servicio}** con ID **{userToEdit.id}** y nivel **{userToEdit.nivel}**?
            </p>
