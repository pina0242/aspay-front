...
export const Listsdet = () => {
  ...
  // useEffect que se encarga de iniciar todo el flujo
  useEffect(() => {
  ...
  const handleEncryptedData = async (encryptedBody) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL}/listsdet`, {
        method: 'POST',
        headers: {
  ...
  // 1. CÁLCULO DE ÍNDICES Y ELEMENTOS ACTUALES
  // Usamos useMemo para recalcular solo cuando currentPage o itemsPerPage cambian
